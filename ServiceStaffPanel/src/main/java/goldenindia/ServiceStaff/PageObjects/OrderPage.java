...
public class OrderPage extends CommonUtilities {
    ...
    private List<WebElement> courseClearButtons;
    ...
    public void addingTheProductsToCourse() throws InterruptedException {
        ...
        String courseProducts[][] = { 
            { "Soft Drink 1", "Alcohol Drink 1" }, // Course 1
    ...
    public void clearingTheItemsInCourse() {
        for (WebElement courseClearButton : courseClearButtons) {
            System.out.println(courseClearButton.getText());
            if (courseClearButton.getText().trim().contains("Clear All Items")) {
                courseClearButton.click();
            }
        }
    }
}
